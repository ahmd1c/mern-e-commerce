...
function CategoriesList() {
    ...
    return (
        <div className="categories-list-cont">
            ...
            {showCategoryModal &&
                <Modal setShowModal={setShowCategoryModal} >
                    <form className="category-form" onSubmit={addNewCategory}>
...

            {
                ...
                <Modal setShowModal={setShowSubCategoryModal}  >
                    <form className="category-form" onSubmit={addNewSubCategory}>
